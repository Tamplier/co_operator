...
ActiveRecord::Schema[8.1].define(version: 2026_02_24_110838) do
  create_table "account_black_lists", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "requester_id", null: false
    t.integer "target_id", null: false
    t.datetime "updated_at", null: false
    t.index ["requester_id", "target_id"], name: "index_account_black_lists_on_requester_id_and_target_id", unique: true
  ...
  create_table "account_preffered_languages", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["account_profile_id", "language_id"], name: "idx_on_account_profile_id_language_id_09a4578ee7", unique: true
  ...
  create_table "account_scheduled_games", force: :cascade do |t|
    ...
    t.index ["schedule_id", "game_id"], name: "index_account_scheduled_games_on_schedule_id_and_game_id", unique: true
  ...
  create_table "schedule_occurrences", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["schedule_id", "start_at"], name: "index_schedule_occurrences_on_schedule_id_and_start_at", unique: true
  ...
  create_table "social_event_profiles", force: :cascade do |t|
    ...
    t.index ["social_event_id", "account_profile_id"], name: "idx_on_social_event_id_account_profile_id_e7370d494a", unique: true
  ...
  create_table "social_messages", force: :cascade do |t|
    ...
    t.index ["recipient_type", "recipient_id"], name: "index_social_messages_on_recipient"
  end
  ...
  create_table "social_requests", force: :cascade do |t|
    ...
    t.index ["target_profile_id", "social_event_id", "request_type"], name: "idx_on_target_profile_id_social_event_id_request_ty_f6ff4f78f1", unique: true, where: "status != 1"
  ...
  create_table "social_reviews", force: :cascade do |t|
    ...
    t.string "text", limit: 2048
    t.datetime "updated_at", null: false
    t.index ["author_id", "target_id", "target_type"], name: "idx_on_author_id_target_id_target_type_f114ef90b0", unique: true
    t.index ["author_id"], name: "index_social_reviews_on_author_id"
    t.index ["target_type", "target_id"], name: "index_social_reviews_on_target"
  end
  ...
  create_table "social_votes", force: :cascade do |t|
    ...
    t.index ["social_request_id", "account_profile_id"], name: "index_social_votes_on_social_request_id_and_account_profile_id", unique: true
  ...
  add_foreign_key "social_reviews", "account_profile", column: "author_id"
